...
import 'package:percent_indicator/linear_percent_indicator.dart';
  import 'package:pma/team_leader/screens/projects/edit_project.dart';
import 'package:pma/theme.dart';


class TlProjectContainer extends StatefulWidget {
  ...
  @override
  _TlProjectContainerState createState() => _TlProjectContainerState();
}

class _TlProjectContainerState extends State<TlProjectContainer> {
                ...
                children: [
                      ...
                      onTap: () {
                          Navigator.push(
                                context,
                                MaterialPageRoute(
                                  builder: (context) => TlEditProject(projectId: widget.projectId!, projectTitle: widget.projectName, description: widget.description, type: widget.type, status: widget.status, priority: widget.priority, dateFin: widget.dateFin, teamLeaderId: widget.teamLeaderId, equipe: widget.equipe,),
                                ),
                              );                      },
                      child: Icon(
                        Icons.edit_outlined,
