...
import 'package:pma/team_leader/screens/risks/tl_edit_risks.dart';
import 'package:pma/theme.dart';

class TlRiskContainer extends StatefulWidget {
  final Risk risk;
  const TlRiskContainer({super.key, required this.risk});

  @override
  State<TlRiskContainer> createState() => _TlRiskContainerState();
}

class _TlRiskContainerState extends State<TlRiskContainer> {
              ...
              children: [ 
                ...
                Row(
                  ...
                  children: [
                    GestureDetector(
                      onTap: () {
                        showDialog(context: context, builder: (context) => TlEditRiskPopup(risk: widget.risk));
                       },
                      child: Icon(
                        Icons.edit_outlined,
                        size: 35.sp,
