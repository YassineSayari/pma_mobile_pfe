...
import 'package:pma/client/screens/projects/client_rate_project.dart';
import 'package:pma/custom_snackbar.dart';
import 'package:pma/services/project_service.dart';
import 'package:pma/theme.dart';


class ClientProjectContainer extends StatefulWidget {
 ...
 ClientProjectContainer({
  ...
  @override
  _ClientProjectContainerState createState() => _ClientProjectContainerState();
}

class _ClientProjectContainerState extends State<ClientProjectContainer> {
            ...
            Positioned(
              ...
              child: Row(
                ...
                children: [
                       GestureDetector(
        onTap: () {
          if (widget.status == 'Completed' && widget.progress == 100) {
            Navigator.push(
              context,
              MaterialPageRoute(
                builder: (context) => ClientRate(projectId:widget.projectId,projectname:widget.projectName),
              ),
            );
          } else {
            ScaffoldMessenger.of(context).showSnackBar(
              SnackBar(
                              content: FailSnackBar(message: " You can only rate a completed project with 100% progress."),
                    ...
                    children: [
                      ...
                      TextButton(
                        onPressed: () {
                          ...
                          Navigator.of(context).pushReplacementNamed("/client_projects");
                          ScaffoldMessenger.of(context).showSnackBar(
                            SnackBar(
